...
CREATE TABLE NguoiDung (
    ...
    CONSTRAINT age_check CHECK (dbo.calc_age(namSinh) >= 16 AND dbo.calc_age(namSinh) <= 100), 
 	matKhau VARCHAR(50),
	gioiTinh NCHAR(3),
    CONSTRAINT sex_check CHECK (gioiTinh = 'Nam' OR gioiTinh = 'Nữ')
);
...
CREATE TABLE DonHang (
    ...
    CONSTRAINT ordStt_check CHECK (tinhTrang = 'Đã giao' OR tinhTrang = 'Đang giao' OR tinhTrang = 'Đã huỷ'),
    ngayTao DATE,                    
    xa NVARCHAR(20),           
    huyen NVARCHAR(20),             
    hinh NVARCHAR(20),              
...
CREATE TABLE HoaDon (
    ...
    tinhTrang NVARCHAR(20),
    CONSTRAINT billStt_check CHECK (tinhTrang = 'Đã thanh toán' OR tinhTrang = 'Chưa thanh toán')
);
...
CREATE TABLE GiaoDich(
    ...
    CONSTRAINT transMethod_check CHECK (phuongThuc = 'Tiền mặt' OR phuongThuc = 'Thẻ' OR phuongThuc = 'Chuyển khoản NH'),
    tinhTrang NVARCHAR(10),
    CONSTRAINT transStt_check CHECK (tinhTrang = 'Thành công' OR tinhTrang = 'Thất bại')
);
